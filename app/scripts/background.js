...
(function () {
  ...
  function resize() {
    canvas.width = document.querySelector('#aside').offsetWidth;
    canvas.height = document.querySelector('#aside').offsetHeight;
  }
  ...
  gradientColor.addColorStop(0, '#614385');
  gradientColor.addColorStop(1, '#516395');
